...
DABEST-Matlab can be installed either via MATLAB Central (https://www.mathworks.com/matlabcentral/fileexchange/65260-bootstrap-contrast-m) or GitHub (how to clone a repo: https://help.github.com/articles/cloning-a-repository/).
